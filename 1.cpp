...
int main() { 
    ...
    pizzerias[0] = new Pizzeria(1, 1, "Dodo"); 
    pizzerias[1] = new Pizzeria(2, 2, "Mimo"); 
    pizzerias[2] = new Pizzeria(4, 3, "York"); 
    ...
    Person* persons[3]; 
    persons[0] = new Person(12, "Gena", 30, true, "Address1"); 
    persons[1] = new Person(19, "Viktor", 25, true, "Address2"); 
    persons[2] = new Person(87, "Yuriy", 40, true, "Address3"); 
 
    PersonVisit* visits[3]; 
    visits[0] = new PersonVisit(99, 12, 1, true); 
    visits[1] = new PersonVisit(68, 19, 2, true); 
    visits[2] = new PersonVisit(85, 87, 3, true); 
 
    PersonOrder* orders[3]; 
    orders[0] = new PersonOrder(94, 12, 54, true); 
    orders[1] = new PersonOrder(24, 19, 23, true); 
    orders[2] = new PersonOrder(621, 87, 76, true); 
